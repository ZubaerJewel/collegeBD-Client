    ...
    return (
        ...
        <Carousel>
                <div>
                    ...
                    <div className="absolute flex justify-center items-center h-full  transform  left-0  bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className='text-purple-300 space-y-5 pl-10 w-1/2'data-aos="zoom-in"
           data-aos-duration="2000">
            <h1 className='mt-3 text-2xl md:text-5xl w-full'>Welcome to <span className="text-purple-200">Colleges of Bangladesh</span></h1>
            <h2 className='md:text-5xl '>We provided the best services from others.Education is the best key success in life</h2>
                ...
                <div>
                    ...
                    <div className="absolute justify-center items-center h-full flex transform  left-0  bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
